                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row items-end justify-between gap-12">
                        ...
                        >
                            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                                Renovix Nordic erbjuder städtjänster i Gävle. Vi
                                hjälper privatpersoner och företag i Sandviken
                                och hela Gävleborg med tjänster som passar deras
                                vardag.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    >
                        {[
                            ...
                            {
                                value: "100%",
                                label: "Försäkrad hos Trygg-Hansa",
                            },
                            {
                                value: "50%",
                                label: "RUT-avdrag direkt på fakturan",
                            },
                            {
                                value: "0 kr",
                            ...
                            >
                                <div className="relative z-10 h-full flex flex-col justify-between">
                                    <div>
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest text-[#1e3a5f]/40 dark:text-white/40 mb-2 block">
                                            {service.category}
                                        </span>
                                    ...
                                    <Link
                                        ...
                                        className="flex items-center gap-2 text-[#1e3a5f] dark:text-[#f59e0b] font-bold text-sm hover:underline mt-auto"
                                    >
                                        Läs mer om tjänsten{" "}
