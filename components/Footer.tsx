            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-16 mb-20">
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-slate-400 dark:text-slate-500 text-sm leading-relaxed max-w-xs">
                            Vi sätter guldstandarden för hem- och
                            företagstjänster i Gävle med omnejd. Din partner för
                            en renare vardag.
                        </p>
                    </div>

                    <div>
                        <h2 className="font-bold text-[#1e3a5f] dark:text-white mb-6">
                            Företaget
                        </h2>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center pt-12 border-t border-slate-100 dark:border-white/5 gap-6">
                    <div className="text-center sm:text-left">
                        <p className="text-slate-400 dark:text-slate-500 text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-1">
                            © 2026 Renovix Nordic. Alla rättigheter förbehållna.
                        </p>
                        <p className="text-slate-400 dark:text-slate-500 text-[9px] sm:text-[10px] uppercase tracking-wider">
                            Renovix Nordic (Enskild firma) | Godkänd för F-skatt
                        </p>
                    </div>
                    <div className="flex gap-8">
                        {["Instagram", "LinkedIn", "Twitter"].map((social) => (
                            <a
                                key={social}
                                href="#"
                                className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 hover:text-[#1e3a5f] dark:hover:text-white transition-colors"
                                aria-label={`Följ oss på ${social}`}
                            >
                                {social}
                            </a>
                        ))}
